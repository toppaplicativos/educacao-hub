      ...
      <main id="main-content">
        <section class="hero"><div class="wrap senta-grid senta-hero">
          <div class="hero-copy">
            ...
            <h1>Em 50 minutos você treina a prova com o cronômetro ligado.</h1>
            ...
            <p class="hero-note">Acesso na hora. 7 dias para desistir.</p>
            <p class="senta-effect" style="margin:1rem 0 .6rem">A solução: um app liga o cronômetro da prova (50, 90 ou 120 minutos). Você responde as questões sem pausar. No fim anota se faltou tempo ou se não sabia a matéria. O guia em PDF ensina o método.</p><p class="hero-lede">Você estuda horas em casa e pausa quando quer. No dia da prova o fiscal corta o tempo e você ainda está no meio das questões. A matéria você sabia. Você nunca treinou com o cronômetro da prova ligado.</p>
            <div class="senta-proof"><span>Treino no tempo da prova</span><span>R$ 27,90</span><span>PDF 14 páginas + app</span><span>Garantia 7 dias</span></div>
            <blockquote class="senta-quote" style="margin-top:1.2rem;overflow:auto">
        ...
        <section class="section" id="virada"><div class="wrap">
          <p class="eyebrow">A SOLUÇÃO</p>
          <h2>A solução é treinar com o cronômetro da prova ligado.</h2>
          <p class="copy">Não é falta de matéria. É treinar sem o tempo que a prova cobra. Você escolhe 50, 90 ou 120 minutos, responde as questões sem pausar e anota o que aconteceu.</p>
          <p class="senta-effect">Cronômetro na frente. Questões sem pausa. No fim você anota: faltou tempo, não sabia, ou deu tempo.</p>
          <div class="senta-steps" style="margin-top:1.4rem">
            <article class="senta-step"><h3>Ligue o cronômetro da prova</h3><p>50, 90 ou 120 minutos. O mesmo tempo da sua banca. Não um treino de 12 minutos.</p></article>
            <article class="senta-step"><h3>Responda as questões sem pausar</h3><p>Sem caderno. Sem celular. O fiscal não espera você voltar.</p></article>
            <article class="senta-step"><h3>Anote o que aconteceu</h3><p>Faltou tempo. Não sabia a matéria. Deu tempo. Aí o próximo treino muda.</p></article>
          </div>
        </div></section>

        <section class="section"><div class="wrap">
          <p class="eyebrow">MÉTODO</p>
          <h2>Três passos. O cronômetro da prova fica na sua frente.</h2>
          <p class="copy">O PDF ensina o método. O app Relógio da Prova aplica. Você escolhe a duração. Responde as questões. Anota o que aconteceu.</p>
        </div></section>

        <section class="section light" id="app"><div class="wrap">
          <p class="eyebrow">O APP · RELÓGIO DA PROVA</p>
          <h2>O cronômetro. As questões. A anotação no fim.</h2>
          <div class="senta-app" style="margin-top:2rem">
            <div class="senta-copy"><p class="eyebrow">NO APP · PASSO 1</p><h3>Escolha o tempo da sua prova: 50, 90 ou 120 minutos.</h3><p>Você abre o app e liga o cronômetro no mesmo tempo da banca. Sem fingir que tem 4 horas.</p><p class="senta-effect">O treino vira o tempo da prova.</p>
              <div class="senta-box"><p><b>Situação.</b> Sábado. Você ia sentar até cansar.</p><p><b>Faça.</b> Abra o app. Escolha a duração da sua banca.</p><p><b>Resultado.</b> O cronômetro está na frente. As questões ainda não começaram.</p></div>
              <div class="hero-actions">${cta('Quero o app agora')}</div></div>
            <div class="senta-mock"><img src="${A}/miniapp/montar.webp" alt="Celular com o timer de 50 minutos para começar o bloco"></div>
          </div>
          <div class="senta-app reverse" style="margin-top:2.4rem">
            <div class="senta-copy"><p class="eyebrow">NO APP · PASSO 2</p><h3>Responda as questões com o cronômetro rodando. Sem pausar.</h3><p>O app conta. Você responde. Sem caderno. Sem celular de recado.</p><p class="senta-effect">O tempo anda. A questão também.</p>
              <div class="senta-box"><p><b>Situação.</b> Você quer pausar para olhar a fórmula.</p><p><b>Faça.</b> Fique no treino. Marque feita ou pulei.</p><p><b>Resultado.</b> Um treino que parece prova. Sem pausa para olhar o caderno.</p></div>
              <div class="hero-actions">${cta('Quero o app agora')}</div></div>
            <div class="senta-mock"><img src="${A}/miniapp/sessao.webp" alt="Celular com o bloco em andamento e o relógio caindo"></div>
          </div>
          <div class="senta-app" style="margin-top:2.4rem">
            <div class="senta-copy"><p class="eyebrow">NO APP · PASSO 3</p><h3>No fim, anote se faltou tempo ou se você não sabia a matéria.</h3><p>Faltou tempo. Não sabia. Deu tempo. Sem anotar, o próximo treino não muda.</p><p class="senta-effect">Três opções. Você escolhe o que aconteceu.</p>
              <div class="senta-box"><p><b>Situação.</b> O cronômetro zerou. O reflexo é fechar e esquecer.</p><p><b>Faça.</b> Anote o que aconteceu. Uma linha.</p><p><b>Resultado.</b> Você sabe se faltou ritmo ou conteúdo.</p></div>
              <div class="hero-actions">${cta('Quero o app agora')}</div></div>
        ...
        <section class="section"><div class="wrap">
          <p class="eyebrow">O QUE MUDA NA PRÁTICA</p>
          <h2>Você recebe o guia em PDF e o app que liga o cronômetro da prova.</h2>
          <div class="senta-bens" style="margin-top:1.3rem">
            <article class="senta-ben"><h3>O cronômetro da prova fica na sua frente</h3><p class="copy">Você escolhe 50, 90 ou 120. O app conta. Sem pausa.</p></article>
            <article class="senta-ben"><h3>No fim você sabe o que faltou</h3><p class="copy">Faltou tempo, não sabia ou deu tempo. Sem anotar, o próximo sábado é igual.</p></article>
        ...
        <section class="section" id="antes"><div class="wrap senta-grid">
          <article class="senta-ben" style="background:#0F172A;color:#fff;padding:0;overflow:hidden"><img src="${A}/pain.webp" alt="Mesa cheia de simulados sem relógio" style="width:100%;height:220px;object-fit:cover;opacity:.88"><div style="padding:1.15rem 1.2rem"><p class="eyebrow" style="color:#E2571C">COMO ESTÁ HOJE</p><h3>Estuda até cansar. Pausa o simulado para olhar o caderno. Não sabe se faltou tempo ou matéria.</h3></div></article>
          <article class="senta-ben" style="padding:0;overflow:hidden"><img src="${A}/session.webp" alt="Timer de 50 minutos e três notas: acabou o tempo, não sabia, deu tempo" style="width:100%;height:220px;object-fit:cover"><div style="padding:1.15rem 1.2rem"><p class="eyebrow">COMO FICA</p><h3>O cronômetro da prova fica na frente. Questões sem pausa. No fim você anota se faltou tempo ou matéria.</h3></div></article>
        </div></section>
        <section class="section"><div class="wrap">
          <p class="eyebrow">PROVA SOCIAL</p>
          <h2>O que aconteceu com quem treinou com o cronômetro ligado</h2>
          <p class="copy">Três relatos. Sem promessa de aprovação. Sem nota. Sem ranking.</p>
          <div class="senta-faces" style="margin-top:1.4rem">
        ...
        <section class="senta-offer" id="oferta"><div class="wrap senta-grid">
          <div>
            <p class="eyebrow" style="color:#E2571C">OFERTA IMPERDÍVEL</p>
            <h2>Guia em PDF + app Relógio da Prova. De R$ 97 por R$ 27,90. 7 dias para desistir.</h2>
            <p class="copy">Você abre o app agora. Escolhe 50, 90 ou 120 minutos. Responde as questões com o cronômetro ligado. No fim anota o que aconteceu. O guia em PDF fica no e-mail. Se não servir, pede o dinheiro de volta em 7 dias.</p>
            <div class="senta-stack">
              ...
              <div><span>3 anotações no fim</span><span>Faltou tempo, não sabia, deu tempo</span></div>
            </div>
            <p class="senta-price"><span class="senta-old">R$ 97</span> R$ 27,90</p>
            <p class="offer-visit">Por tempo limitado · <span class="offer-bar-clock" data-clock>20:00</span></p>
            ${cta('Quero treinar no tempo da prova')}
        ...
        <section class="section senta-faq"><div class="wrap">
          ...
          <h2>O que você recebe, o app incluso e a garantia de 7 dias.</h2>
          <div class="faq-list" style="margin-top:1.2rem">
            <details open><summary>O que eu recebo?</summary><p>O guia em PDF e o app Relógio da Prova. O app liga o cronômetro da prova (50, 90 ou 120 minutos). Você responde as questões e, no fim, anota se faltou tempo ou matéria.</p></details>
    ...
    function provaThanksPage() {
      return deliveryThanks({ title:'Acesso | Prova no Tempo da Banca', h1:'Abra o app. Baixe o PDF. Ligue o cronômetro da prova.', lead:'Você não precisa esperar e-mail para usar. O app Relógio da Prova abre agora. O guia de 14 páginas baixa neste botão.', step3:'Escolha 50, 90 ou 120 minutos. Responda as questões. Anote se faltou tempo ou matéria. Um treino hoje.', appHref:'/app/relogio-da-prova', appLabel:'Abrir o app Relógio da Prova', pdfHref: 'https://cdn.jsdelivr.net/gh/toppaplicativos/educacao-hub@e95487171be0f0a7d17ed45a0671f8e53c5980e9/public/guides/prova-no-tempo-da-banca-ebook-v1.0.pdf', pdfLabel:'Baixar o PDF (14 páginas)' });
    }
